...
- **No community/networking/social-commitment tasks during the treatment period.** **Built 2026-08-18** — `getFocusItems()` filters out Relationships-domain items via `TREATMENT_BLOCKED_DOMAINS`. Domain field now populated on all 62 rows (confirmed 2026-08-18).
